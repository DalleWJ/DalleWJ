...
const QUESTIONS = {
  sommer: {
    ...
    mellem: [
      ...
      { q: "Hvilken ferieform viser dette billede?", img: ["images/camping.png"], options: ["Camping", "Storbyferie", "Skiferie", "Krydstogt"], correct: "Camping", fact: "Danmark har over 400 campingpladser." },
    ...
    svaer: [
      ...
      { q: "Hvilket land forbindes med dette flag — et populært rejsemål i Sydøstasien?", img: ["images/flag-thailand.svg"], options: ["Thailand", "Vietnam", "Indonesien", "Malaysia"], correct: "Thailand", fact: "Thailand kaldes ofte 'Smilenes Land'." },
  ...
  mad: {
    ...
    mellem: [
      ...
      { q: "Hvilken frugt viser dette billede?", img: ["images/pineapple.png"], options: ["Ananas", "Kokosnød", "Mango", "Papaya"], correct: "Ananas", fact: "Det kan tage op til to år for en ananas at modne." },
    ...
    svaer: [
      ...
      { q: "Hvilken ret gemmer sig i denne billedgåde?", img: ["images/spaghetti.png", "images/flag-italy.svg"], options: ["Pasta", "Sushi", "Tacos", "Couscous"], correct: "Pasta", fact: "Der findes over 300 forskellige pastaformer." },
  ...
  film: {
    ...
    mellem: [
      ...
      { q: "Hvilken filmklassiker beskriver denne emoji-gåde?", img: ["images/shark.png", "images/water-wave.png"], options: ["Dødens gab (Jaws)", "Titanic", "Find Nemo", "Piraterne fra Det Caribiske Hav"], correct: "Dødens gab (Jaws)", fact: "Filmen fra 1975 regnes som den første 'sommerblockbuster'." },
    ...
    svaer: [
      ...
      { q: "Hvilken klassisk gyserfilm gemmer sig i denne billedgåde?", img: ["images/kitchen-knife.png", "images/droplet.png"], options: ["Psycho", "Halloween", "Scream", "Saw"], correct: "Psycho", fact: "Den berømte bruse-scene tog angiveligt en uges optagelse for under et minuts film." },
  ...
  musik: {
    ...
    mellem: [
      ...
      { q: "Hvilket instrument viser denne emoji-gåde?", img: ["images/saxophone.png"], options: ["Saxofon", "Trompet", "Klarinet", "Fløjte"], correct: "Saxofon", fact: "Saxofonen blev opfundet af belgieren Adolphe Sax i 1840'erne." },
    ...
    svaer: [
      ...
      { q: "Hvilken genre af musik antyder denne gåde?", img: ["images/cowboy-hat-face.png", "images/guitar.png", "images/cactus.png"], options: ["Country", "Jazz", "Hiphop", "Reggae"], correct: "Country", fact: "Genren har rødder i det amerikanske sydstatsfolkemusik." },
  ...
  geografi: {
    nem: [
      ...
      { q: "Hvilket land har dette flag?", img: ["images/flag-japan.svg"], options: ["Japan", "Kina", "Sydkorea", "Vietnam"], correct: "Japan", fact: "Japans tilnavn er 'Solens Rige'." },
    ],
    mellem: [
      ...
      { q: "Hvilket berømt tårn viser denne gåde?", img: ["images/eiffel-tower.png", "images/flag-france.svg"], options: ["Eiffeltårnet", "Big Ben", "Colosseum", "Frihedsgudinden"], correct: "Eiffeltårnet", fact: "Tårnet blev bygget til verdensudstillingen i Paris i 1889." },
    ...
    svaer: [
      ...
      { q: "Hvilket bjerg gemmer sig i denne gåde?", img: ["images/snow-mountain.png", "images/flag-tanzania.svg"], options: ["Kilimanjaro", "Mount Everest", "Fuji", "Matterhorn"], correct: "Kilimanjaro", fact: "Det er Afrikas højeste bjerg." },
  ...
  dyr: {
    nem: [
      ...
      { q: "Hvilket dyr viser denne gåde?", img: ["images/lion.png"], options: ["Løve", "Tiger", "Puma", "Leopard"], correct: "Løve", fact: "Et løvebrøl kan høres op til 8 km væk." },
    ],
    mellem: [
      ...
      { q: "Hvilket dyr gemmer sig i denne gåde?", img: ["images/penguin.png", "images/snowflake.png"], options: ["Pingvin", "Isbjørn", "Sæl", "Pelikan"], correct: "Pingvin", fact: "Pingviner kan ikke flyve, men er til gengæld dygtige svømmere." },
    ...
    svaer: [
      ...
      { q: "Hvilket dyr antyder denne gåde?", img: ["images/koala.png", "images/herb.png"], options: ["Koala", "Panda", "Doven", "Kænguru"], correct: "Koala", fact: "Koalaer sover op til 20 timer i døgnet." },
  ...
  sport: {
    nem: [
      ...
      { q: "Hvilken sport viser denne gåde?", img: ["images/golf-flag.png"], options: ["Golf", "Fodbold", "Tennis", "Bowling"], correct: "Golf", fact: "En runde golf spilles typisk over 18 huller." },
    ],
    mellem: [
      ...
      { q: "Hvilken sport antyder denne gåde?", img: ["images/snowboard.png"], options: ["Snowboard", "Skiløb", "Skøjteløb", "Bobslæde"], correct: "Snowboard", fact: "Sporten blev første gang en OL-disciplin i 1998." },
    ...
    svaer: [
      ...
      { q: "Hvilken vintersport gemmer sig i denne gåde?", img: ["images/curling-stone.png"], options: ["Curling", "Ishockey", "Skøjteløb", "Bob"], correct: "Curling", fact: "Sporten stammer oprindeligt fra Skotland." },
  ...
  alment: {
    ...
    mellem: [
      ...
      { q: "Hvilket naturfænomen viser dette billede?", img: ["images/volcano.png"], options: ["Vulkan", "Jordskælv", "Tornado", "Oversvømmelse"], correct: "Vulkan", fact: "Der findes over 1.500 aktive vulkaner i verden." },
    ...
    svaer: [
      ...
      { q: "Hvilket fænomen viser denne gåde?", img: ["images/rainbow.png"], options: ["Regnbue", "Nordlys", "Solformørkelse", "Tsunami"], correct: "Regnbue", fact: "En regnbue opstår, når lys brydes i vanddråber." },
